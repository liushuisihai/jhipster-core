...
import com.hshbic.skl.domain.repository.SlotsRepository;
import com.hshbic.skl.domain.service.SlotsService;
...
public class SlotsResourceIntTest {
    ...
    private static final String DEFAULT_IS_REQUIRED = "1";
    private static final String UPDATED_IS_REQUIRED = "1B";
