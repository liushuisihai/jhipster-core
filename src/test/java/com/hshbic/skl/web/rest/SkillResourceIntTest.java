...
public class SkillResourceIntTest {
    ...
    private static final SkillType DEFAULT_TYPE = SkillType.DESTINATION;
    private static final SkillType UPDATED_TYPE = SkillType.CUSTOM;

    private static final SkillStatus DEFAULT_STATUS = SkillStatus.DEV;
    private static final SkillStatus UPDATED_STATUS = SkillStatus.REVIEW;
