...
public class SkillResourceIntTest {
    ...
    private static final Long DEFAULT_DEVELOPER_ID = 1L;
    private static final Long UPDATED_DEVELOPER_ID = 2L;
    ...
    private static final String UPDATED_TYPE = "3";

    private static final String DEFAULT_STATUS = "2";
    private static final String UPDATED_STATUS = "3";

    private static final String DEFAULT_CALL_NAME = "AAAAAAAAAA";
    private static final String UPDATED_CALL_NAME = "BBBBBBBBBB";
    ...
    public void createSkill() throws Exception {
        ...
        assertThat(testSkill.getDeveloperId()).isEqualTo(DEFAULT_DEVELOPER_ID);
        assertThat(testSkill.getCategoryId()).isEqualTo(DEFAULT_CATEGORY_ID);
        assertThat(testSkill.getName()).isEqualTo(DEFAULT_NAME);
        assertThat(testSkill.getType()).isEqualTo(DEFAULT_TYPE);
        assertThat(testSkill.getStatus()).isEqualTo(DEFAULT_STATUS);
        assertThat(testSkill.getCallName()).isEqualTo(DEFAULT_CALL_NAME);
        assertThat(testSkill.getCreateTime()).isEqualTo(DEFAULT_CREATE_TIME);
    }
    ...
    @Test
    @Transactional
    public void checkDeveloperIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = skillRepository.findAll().size();
        // set the field null
        skill.setDeveloperId(null);
    ...
    @Test
    @Transactional
    public void checkCallNameIsRequired() throws Exception {
        int databaseSizeBeforeTest = skillRepository.findAll().size();
        // set the field null
        skill.setCallName(null);
    ...
    public void getAllSkills() throws Exception {
        ...
        restSkillMockMvc.perform(get("/api/skills?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].developerId").value(hasItem(DEFAULT_DEVELOPER_ID.intValue())))
            .andExpect(jsonPath("$.[*].categoryId").value(hasItem(DEFAULT_CATEGORY_ID.toString())))
            .andExpect(jsonPath("$.[*].name").value(hasItem(DEFAULT_NAME.toString())))
            .andExpect(jsonPath("$.[*].type").value(hasItem(DEFAULT_TYPE.toString())))
            .andExpect(jsonPath("$.[*].status").value(hasItem(DEFAULT_STATUS.toString())))
            .andExpect(jsonPath("$.[*].callName").value(hasItem(DEFAULT_CALL_NAME.toString())))
    ...
    public void getSkill() throws Exception {
        ...
        restSkillMockMvc.perform(get("/api/skills/{id}", skill.getId()))
            ...
            .andExpect(jsonPath("$.developerId").value(DEFAULT_DEVELOPER_ID.intValue()))
            .andExpect(jsonPath("$.categoryId").value(DEFAULT_CATEGORY_ID.toString()))
            .andExpect(jsonPath("$.name").value(DEFAULT_NAME.toString()))
            .andExpect(jsonPath("$.type").value(DEFAULT_TYPE.toString()))
            .andExpect(jsonPath("$.status").value(DEFAULT_STATUS.toString()))
            .andExpect(jsonPath("$.callName").value(DEFAULT_CALL_NAME.toString()))
    ...
    public void updateSkill() throws Exception {
        ...
        updatedSkill
            .developerId(UPDATED_DEVELOPER_ID)
            .categoryId(UPDATED_CATEGORY_ID)
            .name(UPDATED_NAME)
            .type(UPDATED_TYPE)
            .status(UPDATED_STATUS)
            .callName(UPDATED_CALL_NAME)
        ...
        Skill testSkill = skillList.get(skillList.size() - 1);
        assertThat(testSkill.getDeveloperId()).isEqualTo(UPDATED_DEVELOPER_ID);
        assertThat(testSkill.getCategoryId()).isEqualTo(UPDATED_CATEGORY_ID);
        assertThat(testSkill.getName()).isEqualTo(UPDATED_NAME);
        assertThat(testSkill.getType()).isEqualTo(UPDATED_TYPE);
        assertThat(testSkill.getStatus()).isEqualTo(UPDATED_STATUS);
        assertThat(testSkill.getCallName()).isEqualTo(UPDATED_CALL_NAME);
        assertThat(testSkill.getCreateTime()).isEqualTo(UPDATED_CREATE_TIME);
    }
