...
import com.mycompany.myapp.repository.WordGroupRepository;
...
public class WordGroupResourceIntTest {
    ...
    private static final Long DEFAULT_DICTIONARY_ID = 1L;
    private static final Long UPDATED_DICTIONARY_ID = 2L;
    ...
    public void createWordGroup() throws Exception {
        ...
        assertThat(testWordGroup.getDictionaryId()).isEqualTo(DEFAULT_DICTIONARY_ID);
    }
    ...
    @Test
    @Transactional
    public void checkDictionaryIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = wordGroupRepository.findAll().size();
        // set the field null
        wordGroup.setDictionaryId(null);
    ...
    public void getAllWordGroups() throws Exception {
        ...
        restWordGroupMockMvc.perform(get("/api/word-groups?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].dictionaryId").value(hasItem(DEFAULT_DICTIONARY_ID.intValue())));
    }
    ...
    public void getWordGroup() throws Exception {
        ...
        restWordGroupMockMvc.perform(get("/api/word-groups/{id}", wordGroup.getId()))
            ...
            .andExpect(jsonPath("$.dictionaryId").value(DEFAULT_DICTIONARY_ID.intValue()));
    }
    ...
    public void updateWordGroup() throws Exception {
        ...
        updatedWordGroup
            ...
            .dictionaryId(UPDATED_DICTIONARY_ID);
        ...
        assertThat(testWordGroup.getDictionaryId()).isEqualTo(UPDATED_DICTIONARY_ID);
    }
