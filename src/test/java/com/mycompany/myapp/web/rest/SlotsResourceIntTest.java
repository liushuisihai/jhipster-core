...
public class SlotsResourceIntTest {
    ...
    private static final String UPDATED_IS_REQUIRED = "0B";

    private static final String DEFAULT_QUESTION = "AAAAAAAAAA";
    private static final String UPDATED_QUESTION = "BBBBBBBBBB";

    private static final COMMONSTATUS DEFAULT_STATUS = COMMONSTATUS.NORMAL;
    private static final COMMONSTATUS UPDATED_STATUS = COMMONSTATUS.DELETE;
