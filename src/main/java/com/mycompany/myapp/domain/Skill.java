...
public class Skill implements Serializable {
    ...
    public SkillCategory getOwner() {
        return owner;
    }

    public Skill owner(SkillCategory skillCategory) {
        this.owner = skillCategory;
        return this;
    }

    public void setOwner(SkillCategory skillCategory) {
        this.owner = skillCategory;
    }
    ...
    public Skill owner(Developer developer) {
